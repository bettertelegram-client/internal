...
void otrl_context_dump(FILE *f, const ConnContext *context)
{
	...
	context->otr_offer ==ConnContext::OFFER_NOT ? "NOT" :
	context->otr_offer ==ConnContext::OFFER_SENT ? "SENT" :
	context->otr_offer ==ConnContext::OFFER_REJECTED ? "REJECTED" :
	context->otr_offer ==ConnContext::OFFER_ACCEPTED ? "ACCEPTED" :
	"INVALID");
	...
	const char * protocol)
{
    ...
    context = (ConnContext*)malloc(sizeof(ConnContext));
    assert(context != NULL);
    ...
    smstate = (OtrlSMState*) malloc(sizeof(OtrlSMState));
    assert(smstate != NULL);
    ...
    context->otr_offer =ConnContext::OFFER_NOT;
